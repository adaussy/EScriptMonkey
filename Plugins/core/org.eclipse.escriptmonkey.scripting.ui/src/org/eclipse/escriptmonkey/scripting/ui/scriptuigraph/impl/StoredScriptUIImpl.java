 ...
 * <ul>
 *   <li>{@link org.eclipse.escriptmonkey.scripting.ui.scriptuigraph.impl.StoredScriptUIImpl#getPath <em>Path</em>}</li>
...
public class StoredScriptUIImpl extends SubNodeImpl implements StoredScriptUI {
	...
	public void setPath(String newPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScriptuigraphPackage.STORED_SCRIPT_UI__PATH, oldPath, path));
	}

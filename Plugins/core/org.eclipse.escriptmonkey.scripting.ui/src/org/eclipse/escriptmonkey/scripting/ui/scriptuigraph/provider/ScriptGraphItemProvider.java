 ...
 * @generated
 */
public class ScriptGraphItemProvider
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ScriptuigraphPackage.Literals.SCRIPT_GRAPH__NODES,
				 ScriptuigraphFactory.eINSTANCE.createScriptSetUI()));

		newChildDescriptors.add
			(createChildParameter
				(ScriptuigraphPackage.Literals.SCRIPT_GRAPH__NODES,
				 ScriptuigraphFactory.eINSTANCE.createStoredScriptUI()));

		newChildDescriptors.add
			(createChildParameter
				(ScriptuigraphPackage.Literals.SCRIPT_GRAPH__NODES,
				 ScriptuigraphFactory.eINSTANCE.createRoot()));
	}

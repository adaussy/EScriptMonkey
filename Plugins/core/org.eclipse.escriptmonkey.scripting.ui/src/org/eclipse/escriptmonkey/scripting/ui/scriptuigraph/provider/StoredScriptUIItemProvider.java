...
public class StoredScriptUIItemProvider extends SubNodeItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	...
	protected void addPathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_StoredScriptUI_path_feature"), getString("_UI_PropertyDescriptor_description", "_UI_StoredScriptUI_path_feature", "_UI_StoredScriptUI_type"), ScriptuigraphPackage.Literals.STORED_SCRIPT_UI__PATH, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((StoredScriptUI)object).getName();
		return label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case ScriptuigraphPackage.STORED_SCRIPT_UI__PATH:

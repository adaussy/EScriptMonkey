...
public class Delete extends AbstractHandler implements IHandler {
    ...
    public static final String COMMAND_ID = "org.eclipse.escriptmonkey.commands.macro.delete";
    public static final String PARAMETER_NAME = "org.eclipse.escriptmonkey.commands.macro.delete.name";

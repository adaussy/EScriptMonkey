...
public class TextFieldEditor extends FieldEditor {
	 ...
	 *            the parent of the field editor's control
	 */
	public TextFieldEditor(final String name, final String labelText, final int width, final Composite parent) {
	 ...
	 *            the parent of the field editor's control
	 */
	public TextFieldEditor(final String name, final String labelText, final Composite parent) {
			...
			switch (validateStrategy) {
				case VALIDATE_ON_KEY_STROKE:
					...
					textField.addFocusListener(new FocusAdapter() {
						// Ensure that the value is checked on focus loss in
						// case we
						// missed a keyRelease or user hasn't released key.
						// See
						// https://bugs.eclipse.org/bugs/show_bug.cgi?id=214716
						@Override
